...
`
  ...
  if (document.querySelector('.map') !== null) {
    ...
    function init() {
      var myMap = new ymaps.Map("map", {
        ...
        myPlacemark = new ymaps.Placemark([52.961965, 36.069167], {
          ...
          iconImageHref: '/assets/img/logo-map.svg',
          // Размеры метки.
          iconImageSize: [50, 50],
  ...
  const boxes = Array.from(document.querySelectorAll(".price__box")); // считываем все элементы аккордеона в массив
  ...
  function boxHandler(e) {
    ...
    let currentBox = e.target.closest(".price__box"); // определяем текущий бокс
